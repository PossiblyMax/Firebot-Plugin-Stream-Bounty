...
export const StreamBountyPlayerIdVariable: ReplaceVariable = {
    definition: {
        handle: `${VARIABLE_PREFIX}PlayerId`,
        description: "The player's Twitch ID for the player that has just joined/used bits/registered bingo.",
    ...
    evaluator: async (trigger) => {
        return (trigger.metadata?.eventData as StreamBountyPlayerPayloadData)?.playerId ?? "";
    }
};